...
import Loader from "../../components/civs/Loader";
...
const CivsPage = () => {
    ...
    <> 
        <div className='bg bg-yellow-50 py-10'>
            <h1 className="flex justify-center text-4xl md:text-5xl font-bold text-neutral-900 drop-shadow-md">Civilizaciones</h1>   
        </div>

        <section className="flex flex-col gap-4 justify-center items-center py-8 px-4 md:px-24 lg:px-32 2xl:px-64">
